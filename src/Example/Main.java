...
public class Main {
    ...
    private static final String GA_CONFIG_FILE = "src/Example/properties/geneticAlgorithm.properties";
    private static final String MAIN_CONFIG_FILE = "src/Example/properties/bitstring.properties";
